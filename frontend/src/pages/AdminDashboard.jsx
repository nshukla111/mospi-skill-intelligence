...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-6 animate-fadeIn pb-12">
      ...
      <div className="glass-card rounded-3xl p-6 border border-amber-800/40 bg-gradient-to-br from-slate-900 via-slate-950 to-amber-950/20 shadow-2xl relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-amber-500/10 rounded-full blur-3xl pointer-events-none"></div>

        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
          <div className="flex items-center space-x-3.5">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-amber-500 via-rose-600 to-indigo-600 p-0.5 shadow-xl flex items-center justify-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5 mt-6 pt-6 border-t border-slate-800/80">
          <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-800">
            ...
            <p className="text-2xl font-extrabold text-amber-300 font-mono mt-1">750</p>
          ...
          <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-800">
            ...
            <span className="text-[10px] text-emerald-400 font-semibold">+4.2% YoY Improvement</span>
          </div>

          <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-800">
            <span className="text-[11px] text-slate-400 font-medium">Active NSSTA Cohorts</span>
            <p className="text-2xl font-extrabold text-indigo-300 font-mono mt-1">5</p>
            <span className="text-[10px] text-indigo-400 font-semibold">180 Officers Enrolled</span>
          </div>

          <div className="p-3.5 rounded-2xl bg-slate-900/80 border border-slate-800">
            <span className="text-[11px] text-slate-400 font-medium">Critical Skill Alerts</span>
            <p className="text-2xl font-extrabold text-rose-300 font-mono mt-1">2</p>
            <span className="text-[10px] text-rose-400 font-semibold">ML & Scanner Pricing</span>
          </div>
        </div>
